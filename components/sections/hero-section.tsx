    ...
    <section id="home" className="relative overflow-hidden py-20 sm:py-28">
      ...
      <div className="relative mx-auto grid w-full max-w-6xl gap-14 px-6 md:grid-cols-[1.1fr_0.9fr] md:items-center">
        <div className="reveal">
          <p className="mb-6 inline-flex rounded-full border border-border bg-white px-3 py-1 text-xs font-medium uppercase tracking-[0.2em] text-muted">
            {hero.eyebrow}
          </p>
          <h1 className="font-heading text-4xl font-semibold leading-tight tracking-tight text-text sm:text-5xl md:text-6xl">
            {hero.title}
          </h1>
          ...
          <div className="mt-9 flex flex-wrap items-center gap-4">
            <a
              href="#contact"
              className="rounded-full bg-accent px-6 py-3 text-sm font-semibold text-white transition hover:-translate-y-0.5 hover:bg-blue-600"
            >
              {hero.primaryCta}
            </a>
            <a
              href="#services"
              className="rounded-full border border-border bg-white px-6 py-3 text-sm font-medium text-text transition hover:border-slate-300 hover:bg-slate-50"
            >
              {hero.secondaryCta}
            </a>
          </div>
        ...
        <div className="reveal md:[animation-delay:180ms]">
          <div className="relative rounded-3xl border border-border bg-white/95 p-6 shadow-glow backdrop-blur-xl">
